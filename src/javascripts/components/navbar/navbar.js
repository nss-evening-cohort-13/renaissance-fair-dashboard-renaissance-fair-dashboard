...
const navbar = (currentUser) => {
  $('#nav').html(
    `<nav class="navbar-all navbar-expand-lg navbar-light bg-light">
      <a class="navbar-brand" href="#" style="color: #E7A336;">FreeLancer</a>
      ...
      <a class="nav-link" href="#" style="color: #E7A336;"><i class="fas fa-crown"></i></i> Souvenirs</a>
      </li>
      <li class="nav-item mx-3" id="staff-link">
        <a class="nav-link" href="#" style="color: #E7A336;"><i class="far fa-grin"></i> Staff</a>
      </li>
      <li class="nav-item mx-3" id="food-link">
        <a class="nav-link" href="#" style="color: #E7A336;"><i class="fas fa-drumstick-bite"></i> Food</a>
      </li>
